...
import { makeStyles, Grid, Typography, Button, Link,Checkbox, Modal, Backdrop, Fade} from "@material-ui/core";
import {
    Input,
    InputLabel,
    IconButton,
            ...
            >
                ...
                <div className={classes.paper}>
                    <div className={classes.maindiv}>
                        <h2 id="transition-modal-title" className={classes.titleterm}>Terms and Conditions</h2>
                        <p id="transition-modal-description" className={classes.para}>
